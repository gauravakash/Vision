import {
  require_jsx_runtime
} from "./chunk-R6XBYYES.js";
import {
  require_react
} from "./chunk-KFF5JOZL.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
var _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _isInitialPausedFetch, isInitialPausedFetch_fn, _dispatch, dispatch_fn, _a5;
...
}, _initialState = new WeakMap(), _revertState = new WeakMap(), _cache = new WeakMap(), _client = new WeakMap(), _retryer = new WeakMap(), _defaultOptions = new WeakMap(), _abortSignalConsumed = new WeakMap(), _isInitialPausedFetch = new WeakSet(), isInitialPausedFetch_fn = function() {
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _trackResult, trackResult_fn, _combineResult, combineResult_fn, _findMatchingObservers, findMatchingObservers_fn, _onUpdate, onUpdate_fn, _notify3, notify_fn3, _a10;
